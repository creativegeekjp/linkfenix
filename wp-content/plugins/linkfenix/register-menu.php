...
isset($_POST) ?  include 'class/messageloaders.php' : "";
        ...
        <b>LinkFenix</b>
            <div id='int-wrapper-content'>
                <div id='int-main-content'>
                    ...
                    <p>
                        PREFERENCES - Change the look of the links and control the auto update settings.
                    </p>
                </div>
...
function movies()
{
        ...
        <form method='post'>
            <div class='wrap'>
                    <b>LinkFenix - Movies</b>
                    <input type='submit' class='button-secondary' name='searchsubmit' value='Options' >
                    <input type='submit' class='button-secondary' name='searchsubmit' value='Full import' >
                    <input type='submit' class='button-secondary' name='searchsubmit' value='Movie List' >
                    <input type='submit' class='button-secondary' name='searchsubmit' value='Updates'>
                <hr id='line'>
                <div id='mov-content'>
                    <?php
                        if(isset($_POST))
                        {
                            switch($_POST['searchsubmit'])
                            {
                                ...
                                case 'Updates' :
                                    include 'movie-updates-list-page.php';
                                break;
...
function tvshows(){
    ...
    <form method='post'>
        <div class='wrap'>
                <b>LinkFenix - TV Shows</b>
                <input type='submit' class='button-secondary' name='tv-searchsubmit' value='Options' >
                <input type='submit' class='button-secondary' name='tv-searchsubmit' value='Full Import' >
                <input type='submit' class='button-secondary' name='tv-searchsubmit' value='Tv Shows' >
                <input type='submit' class='button-secondary' name='tv-searchsubmit' value='Updates'>
            <hr id='line'>
            <div id='mov-content'>
                <?php
                if(isset($_POST))
...
function preferences()
{
    ?>
    <form method='post'>
        <div class='wrap'><b>LinkFenix - Preferences</b>
            <hr id='line'>
            <div id='mov-content'>
